...
*/
#define _SILENCE_STDEXT_HASH_DEPRECATION_WARNINGS // added 201709 by HMC 
...
// OUTDATED template<class T> char* as_bytes(T& i), replaced on 20171016
